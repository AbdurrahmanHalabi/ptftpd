...
In this version the TFTP client is a non-interactive client. 
This way it can be used in one command line. it can be useful for 
Jenkins automation script. please clone the repository 
